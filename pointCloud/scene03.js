var dataPoints03 = (function(){

  var instansiatePoints03 = {};
  var animation03;

  instansiatePoints03.init  = function (scene) {
    // Animation extends THREE.Mesh
    animation03 = new Animation();
    animation03.name = "objAnimation03";
    animation03.animate(8.0, {ease: Power0.easeIn, repeat:0, repeatDelay:0.1, yoyo: true});
    scene.add(animation03);
};
...
function Animation() {
  ...
  for (i = 0; i < prefabCount; i++) {
    startPosition.x = THREE.Math.randFloatSpread(range*instansiatePoints03.mulRangeStart03) + instansiatePoints03.xPosStart;
    startPosition.y = THREE.Math.randFloatSpread(range*instansiatePoints03.mulRangeStart03) + instansiatePoints03.yPosStart;
    startPosition.z = THREE.Math.randFloatSpread(range*instansiatePoints03.mulRangeStart03) + instansiatePoints03.zPosStart;

    endPosition.x = THREE.Math.randFloatSpread(range*instansiatePoints03.mulRangeEnd03) + instansiatePoints03.xPosEnd;
    endPosition.y = THREE.Math.randFloatSpread(range*instansiatePoints03.mulRangeEnd03) + instansiatePoints03.yPosEnd;
    endPosition.z = THREE.Math.randFloatSpread(range*instansiatePoints03.mulRangeEnd03) + instansiatePoints03.zPosEnd;
